...
🌐 **Live Demo**: [https://manifest-three-nu.vercel.app/](https://manifest-three-nu.vercel.app/)
...
- Incoming USDC transaction history, read directly from on-chain  events

## Getting started
No build step required — just open  directly in a browser, or visit the [Live Demo](https://manifest-three-nu.vercel.app/).

1. Clone this repo: 
2. Open  or  with Live Server in VS Code
